...
* на английском вы экономите в 2.5 раза, т.е. в контекст поместиться больше, либо съэкономите на лимите токенов в
  месячной подписки, но согласен на русском легче возможно воспронимать информацию.
...
6) если pdf страница является "текстом", а не картинкой то она таковой и должна остаться чтобы не увеличивать размер (если это не возможно -  сообщи об этом - и можно преобразовать в кратинку)
```
